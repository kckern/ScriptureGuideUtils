...
var raw_index_orig = {
  ...
  "Solomon's Song": [17, 17, 11, 16, 16, 13, 13, 14],
  ...
  "1 Nephi": [20, 24, 31, 38, 22, 6, 22, 38, 6, 22, 36, 23, 42, 30, 36, 39, 55, 25, 24, 22, 26, 31],
  "2 Nephi": [32, 30, 25, 35, 34, 18, 11, 25, 54, 25, 8, 22, 26, 6, 30, 13, 25, 22, 21, 34, 16, 6, 22, 32, 30, 33, 35, 32, 14, 18, 21, 9, 15],
  ...
  "3 Nephi": [30, 19, 26, 33, 26, 30, 26, 25, 22, 19, 41, 48, 34, 27, 24, 20, 25, 39, 36, 46, 29, 17, 14, 18, 6, 21, 33, 40, 9, 2],
  "4 Nephi": [49],
  ...
  "Joseph Smith\u2014Matthew": [55],
  "Joseph Smith\u2014History": [75],
  "Articles of Faith": [13],
  "Lectures on Faith": [53, 359, 74, 41, 44, 13, 20],
  "JST Genesis": [33, 31, 33, 13, 45, 71, 84, 56, 32, 20, 20, 15, 15, 40, 22, 20, 33, 42, 44, 20, 32, 28, 18, 73, 34, 35, 46, 22, 35, 43, 55, 33, 20, 31, 29, 43, 36, 30, 23, 23, 57, 38, 34, 34, 28, 34, 31, 28, 33, 38],
  "JST Exodus": [22, 25, 22, 31, 23, 29, 25, 32, 35, 29, 10, 51, 22, 32, 27, 36, 16, 27, 25, 26, 36, 31, 33, 18, 40, 37, 21, 43, 46, 38, 18, 35, 23, 35, 35, 38, 29, 31, 43, 38],
  "JST Leviticus": [17, 16, 17, 35, 19, 30, 38, 36, 24, 20, 47, 8, 59, 57, 33, 34, 16, 30, 37, 27, 24, 33, 44, 23, 55, 46, 34],
  "JST Numbers": [54, 34, 51, 49, 31, 27, 89, 26, 23, 36, 35, 16, 33, 45, 41, 50, 13, 32, 22, 29, 35, 42, 30, 25, 18, 65, 23, 31, 40, 16, 54, 42, 56, 29, 35, 13],
  "JST Deuteronomy": [46, 37, 29, 49, 33, 25, 26, 20, 29, 22, 32, 33, 18, 29, 23, 22, 20, 22, 21, 20, 23, 30, 25, 22, 19, 19, 26, 69, 29, 20, 30, 52, 29, 12],
  "JST Joshua": [18, 24, 17, 24, 15, 27, 26, 35, 27, 43, 23, 24, 33, 16, 63, 10, 18, 28, 51, 9, 45, 34, 16, 33],
  "JST Judges": [36, 23, 31, 24, 31, 40, 25, 35, 57, 18, 41, 15, 25, 20, 20, 31, 13, 31, 30, 48, 25],
  "JST Ruth": [22, 23, 18, 22],
  "JST 1 Samuel": [28, 36, 21, 22, 12, 21, 17, 22, 27, 27, 15, 25, 23, 53, 35, 23, 58, 30, 24, 42, 15, 23, 29, 22, 44, 26, 12, 25, 11, 31, 13],
  "JST 2 Samuel": [27, 32, 39, 12, 25, 23, 29, 18, 13, 19, 27, 32, 39, 33, 37, 23, 29, 33, 43, 26, 22, 51, 40, 25],
  "JST 1 Kings": [53, 46, 28, 34, 18, 38, 51, 66, 28, 29, 43, 33, 34, 31, 34, 34, 24, 46, 21, 44, 29, 53],
  "JST 2 Kings": [18, 25, 27, 44, 27, 33, 20, 29, 37, 36, 21, 22, 25, 29, 38, 20, 41, 37, 37, 21, 26, 20, 37, 20, 30],
  "JST 1 Chronicles": [54, 55, 24, 43, 26, 81, 40, 40, 44, 14, 47, 40, 14, 18, 29, 43, 27, 17, 19, 8, 30, 19, 33, 31, 31, 32, 34, 21, 30],
  "JST 2 Chronicles": [17, 18, 17, 22, 14, 42, 22, 18, 31, 19, 23, 16, 22, 15, 19, 14, 19, 34, 11, 37, 20, 12, 21, 27, 28, 23, 9, 27, 36, 27, 21, 34, 25, 33, 27, 23],
  "JST Ezra": [11, 70, 13, 24, 17, 22, 28, 36, 15, 44],
  "JST Nehemiah": [11, 20, 32, 23, 19, 19, 73, 18, 38, 39, 36, 48, 31],
  "JST Esther": [22, 23, 15, 17, 14, 14, 10, 17, 32, 3],
  "JST Job": [22, 13, 26, 21, 27, 30, 21, 22, 35, 22, 20, 25, 28, 22, 35, 22, 16, 21, 29, 29, 34, 30, 17, 25, 6, 14, 23, 28, 25, 31, 40, 22, 33, 37, 16, 33, 24, 41, 30, 24, 34, 17],
  "JST Psalms": [6, 12, 8, 8, 12, 10, 17, 9, 20, 18, 7, 8, 6, 7, 5, 11, 15, 50, 14, 9, 13, 31, 6, 10, 22, 12, 14, 9, 11, 12, 24, 11, 22, 22, 28, 12, 40, 22, 13, 17, 13, 11, 5, 26, 17, 11, 9, 14, 20, 23, 19, 9, 7, 7, 23, 13, 11, 11, 17, 12, 8, 12, 11, 10, 13, 19, 7, 35, 36, 5, 24, 20, 28, 23, 10, 12, 20, 72, 13, 19, 16, 8, 18, 12, 13, 17, 7, 18, 52, 17, 16, 15, 5, 23, 11, 14, 12, 9, 9, 5, 8, 28, 22, 35, 45, 48, 43, 13, 31, 7, 10, 10, 9, 8, 18, 19, 2, 29, 198, 7, 8, 9, 4, 6, 5, 6, 5, 6, 8, 8, 3, 18, 3, 3, 21, 26, 9, 8, 24, 13, 10, 7, 12, 15, 21, 10, 20, 14, 9, 6],
  "JST Proverbs": [33, 22, 35, 27, 23, 35, 27, 36, 18, 32, 31, 28, 25, 35, 33, 33, 28, 24, 29, 30, 31, 29, 35, 34, 28, 28, 27, 28, 27, 33, 31],
  "JST Ecclesiastes": [18, 26, 22, 16, 20, 12, 29, 17, 18, 20, 10, 15],
  "JST Isaiah": [31, 22, 27, 5, 30, 13, 25, 22, 21, 34, 16, 6, 22, 32, 9, 14, 14, 7, 25, 6, 17, 25, 18, 23, 12, 21, 13, 29, 32, 33, 9, 20, 24, 17, 10, 22, 38, 22, 8, 31, 29, 25, 28, 28, 25, 13, 15, 22, 26, 8, 23, 15, 12, 17, 13, 12, 21, 14, 21, 22, 11, 12, 19, 12, 25, 24],
  "JST Jeremiah": [19, 37, 25, 31, 31, 30, 34, 22, 26, 25, 23, 17, 27, 22, 21, 21, 27, 23, 15, 18, 14, 30, 40, 10, 38, 24, 22, 17, 32, 24, 40, 44, 26, 22, 19, 32, 21, 28, 18, 16, 18, 22, 13, 30, 5, 28, 7, 47, 39, 46, 64, 35],
  "JST Lamentations": [22, 22, 66, 22, 22],
  "JST Ezekiel": [28, 10, 27, 17, 17, 14, 27, 18, 11, 22, 25, 28, 23, 23, 8, 64, 24, 32, 14, 49, 32, 31, 49, 27, 17, 21, 36, 26, 22, 26, 18, 32, 33, 31, 15, 38, 28, 23, 29, 49, 27, 20, 27, 31, 25, 24, 23, 35],
  "JST Daniel": [21, 49, 30, 37, 31, 28, 28, 27, 27, 21, 46, 13],
  "JST Hosea": [11, 23, 5, 19, 15, 11, 16, 14, 17, 15, 12, 14, 16, 9],
  "JST Joel": [20, 32, 21],
  "JST Amos": [15, 16, 15, 13, 27, 14, 17, 14, 15],
  "JST Obadiah": [21],
  "JST Jonah": [17, 10, 10, 11],
  "JST Micah": [16, 13, 12, 13, 15, 16, 20],
  "JST Nahum": [15, 13, 19],
  "JST Habakkuk": [17, 20, 19],
  "JST Zephaniah": [18, 15, 20],
  "JST Haggai": [15, 23],
  "JST Zechariah": [21, 13, 10, 14, 11, 15, 14, 23, 17, 12, 17, 14, 9, 21],
  "JST Malachi": [14, 17, 18, 6],
  "JST Matthew": [5, 8, 46, 24, 50, 39, 37, 35, 44, 38, 30, 44, 60, 30, 37, 31, 26, 34, 30, 34, 56, 44, 41, 56, 47, 76, 67, 19],
  "JST Mark": [40, 27, 30, 33, 35, 58, 36, 44, 50, 54, 36, 50, 61, 82, 51, 21],
  "JST Luke": [79, 52, 45, 44, 39, 49, 50, 55, 62, 43, 55, 68, 36, 38, 32, 36, 40, 43, 48, 47, 38, 71, 57, 52],
  "JST John": [51, 25, 36, 56, 48, 71, 53, 59, 41, 42, 58, 50, 38, 31, 27, 33, 26, 40, 42, 31, 25],
  "JST Acts": [26, 47, 26, 37, 42, 15, 60, 40, 43, 48, 31, 25, 52, 28, 41, 40, 34, 28, 41, 38, 40, 30, 36, 27, 27, 32, 44, 31],
  "JST Romans": [32, 29, 31, 25, 21, 23, 27, 39, 33, 21, 36, 21, 14, 23, 32, 27],
  "JST 1 Corinthians": [31, 16, 23, 21, 13, 20, 40, 13, 27, 33, 34, 31, 13, 40, 58, 24],
  "JST 2 Corinthians": [24, 17, 18, 18, 21, 18, 16, 24, 15, 18, 33, 21, 14],
  "JST Galatians": [24, 21, 29, 31, 26, 18],
  "JST Ephesians": [23, 22, 21, 32, 33, 24],
  "JST Philippians": [30, 30, 21, 23],
  "JST Colossians": [29, 22, 25, 18],
  "JST 1 Thessalonians": [10, 20, 13, 18, 28],
  "JST 2 Thessalonians": [12, 17, 18],
  "JST 1 Timothy": [20, 15, 16, 16, 25, 21],
  "JST 2 Timothy": [18, 26, 17, 22],
  "JST Titus": [16, 15, 15],
  "JST Philemon": [25],
  "JST Hebrews": [14, 18, 19, 16, 14, 20, 27, 13, 28, 39, 40, 29, 25],
  "JST James": [27, 25, 18, 17, 20],
  "JST 1 Peter": [25, 25, 22, 19, 14],
  "JST 2 Peter": [21, 22, 18],
  "JST 1 John": [10, 29, 24, 21, 21],
  "JST 2 John": [13],
  "JST 3 John": [14],
  "JST Jude": [25],
  "JST Revelation": [20, 29, 22, 11, 14, 17, 17, 13, 21, 11, 19, 17, 18, 20, 8, 21, 18, 24, 21, 15, 27, 21],
  "1 Esdras": [58, 30, 24, 63, 73, 34, 15, 96, 55],
  "2 Esdras": [40, 48, 36, 52, 56, 59, 70, 63, 47, 59, 46, 51, 58, 48, 63, 78],
  "Additions to Esther": [13, 12, 6, 18, 19, 16, 24],
  "1 Maccabees": [64, 70, 60, 61, 68, 63, 50, 32, 73, 89, 74, 53, 53, 49, 41, 24],
  "2 Maccabees": [36, 32, 40, 50, 27, 31, 42, 36, 29, 38, 38, 45, 26, 46, 39],
  "Tobit": [22, 14, 17, 21, 22, 17, 18, 21, 6, 12, 19, 22, 18, 15],
  "Judith": [16, 28, 10, 15, 24, 21, 32, 36, 14, 23, 23, 20, 20, 19, 13, 25],
  "Wisdom of Solomon": [16, 24, 19, 20, 23, 25, 30, 21, 18, 21, 26, 27, 19, 31, 19, 29, 21, 25, 22],
  "Ecclesiasticus": [30, 18, 31, 31, 15, 37, 36, 19, 18, 31, 34, 18, 26, 27, 20, 30, 32, 33, 30, 32, 28, 27, 28, 34, 26, 29, 30, 26, 28, 25, 31, 24, 31, 26, 20, 26, 31, 34, 35, 30, 24, 25, 33, 22, 26, 20, 25, 25, 16, 29, 30],
  "Baruch": [22, 35, 37, 37, 9],
  "Epistle of Jeremiah": [73],
  "Prayer of Azariah": [68],
  "Susanna": [64],
  "Bel and the Dragon": [42],
  "Prayer of Manasseh": [14]
};
var raw_regex_orig = {
  "books": [["gen\\.*(?:e*sis)*", "Genesis"], ["exo*\\.*(?:dus)*", "Exodus"], ["levi*t*\\.*(?:icus)*", "Leviticus"], ["num\\.*(?:bers)*", "Numbers"], ["deut\\.*(?:eronomy)*", "Deuteronomy"], ["josh\\.*(?:ua)*", "Joshua"], ["judg\\.*(?:es)*", "Judges"], ["rut*h*\\.*", "Ruth"], ["sam*u*\\.*(?:el)*", "Samuel"], ["ki*n*gs*\\.*", "Kings"], ["chr*o*n*\\.*(?:icles)*", "Chronicles"], ["ezr*\\.*(?:a)*", "Ezra"], ["neh\\.*(?:emiah)*", "Nehemiah"], ["esth*\\.*(?:er)*", "Esther"], ["job", "Job"], ["ps\\.*(?:a)*\\.*(?:lm)*\\.*(?:s)*", "Psalms"], ["prov\\.*(?:erbs)*", "Proverbs"], ["eccl*\\.*(?:esiastes)*", "Ecclesiastes"], ["(the )*song*\\.*(?: *of *solomon)*", "Solomon's Song"], ["isa\\.*(?:iah)*", "Isaiah"], ["jer\\.*(?:emiah)*", "Jeremiah"], ["lame*n*t*\\.*(?:ations)*", "Lamentations"], ["eze*k*\\.*(?:iel)*", "Ezekiel"], ["dan\\.*(?:iel)*", "Daniel"], ["hos*\\.*(?:ea)*", "Hosea"], ["joel*\\.*", "Joel"], ["amos*\\.*", "Amos"], ["obad\\.*(?:iah)*", "Obadiah"], ["jon*\\.*(?:ah)*", "Jonah"], ["mic*\\.*(?:ah)*", "Micah"], ["nah*\\.*(?:um)*", "Nahum"], ["hab*\\.*(?:akuk)*", "Habakkuk"], ["zeph*\\.*(?:aniah)*", "Zephaniah"], ["hag\\.*(?:gai)*", "Haggai"], ["zech*\\.*(?:ariah)*", "Zechariah"], ["mal*\\.*(?:achi)*", "Malachi"], ["(?:mat*t*h*|mt)\\.*(?:ew)*", "Matthew"], ["m(ar)*k", "Mark"], ["lu*k*e*\\.*", "Luke"], ["jo*h*n\\.*", "John"], ["(?:the )*act*s*\\.*(?: of the apostles)*", "Acts"], ["rom*\\.*(?:ans)*", "Romans"], ["cor\\.*(?:inthians)*", "Corinthians"], ["gal*a*\\.*(?:tians)*", "Galatians"], ["ephe*\\.*(?:sians)*", "Ephesians"], ["phili*p*\\.*(?:ippians)*", "Philippians"], ["colo*s*\\.*(?:sians)*", "Colossians"], ["thess*\\.*(?:alonians)*", "Thessalonians"], ["tim\\.*(?:othy)*", "Timothy"], ["tit*\\.*(?:us)*", "Titus"], ["philem*o*n*\\.*", "Philemon"], ["he\\.*(?:b)*\\.*(?:rews)*", "Hebrews"], ["ja\\.*(?:me)*s", "James"], ["pet*\\.*(?:er)*", "Peter"], ["ju\\.*(?:d)*\\.*(?:e)*", "Jude"], ["rev\\.*(?:elation)*", "Revelation"], ["1\\s*esd\\.*(?:ras)*", "1 Esdras"], ["2\\s*esd\\.*(?:ras)*", "2 Esdras"], ["add\\.*to\\.*esth\\.*", "Additions to Esther"], ["1\\s*mac\\.*(?:cabees)*", "1 Maccabees"], ["2\\s*mac\\.*(?:cabees)*", "2 Maccabees"], ["tob\\.*", "Tobit"], ["jud\\.*(?:ith)*\\s", "Judith"], ["wisdom(of\\ssolomon)*", "Wisdom of Solomon"], ["ecclesiasticus", "Ecclesiasticus"], ["sirach", "Ecclesiasticus"], ["baruch", "Baruch"], ["bar*\\.*(?:uch)*", "Baruch"], ["epistle\\s*of\\s*jeremiah", "Epistle of Jeremiah"], ["letter\\s*of\\s*jeremiah", "Epistle of Jeremiah"], ["(prayer\\s*of\\s*)*azariah", "Prayer of Azariah"], ["sus\\.*(?:anna)*", "Susanna"], ["bel\\.*", "Bel and the Dragon"], ["bel\\s*(and\\s*)*dragon", "Bel and the Dragon"], ["(prayer\\s*of\\s*)*manasseh", "Prayer of Manasseh"], ["ne\\.*(?:phi)*", "Nephi"], ["jac\\.*(?:ob)*", "Jacob"], ["en\\.*(?:os)*", "Enos"], ["jar\\.*(?:om)*", "Jarom"], ["om\\.*(?:ni)*", "Omni"], ["(?:the *)*w(?:ords)*[ _-]*o[ _-f]*m(?:ormon)*", "Words of Mormon"], ["mos\\.*(?:iah)*", "Mosiah"], ["alma", "Alma"], ["hela*\\.*(?:a*man)*", "Helaman"], ["eth\\.*(?:er)*", "Ether"], ["morm\\.*(?:on)*", "Mormon"], ["moro\\.*(?:ni)*", "Moroni"], ["d(?:octrine)*\\.* *(?:&amp;|&|and)* *c(?:ovenants)*(?:\\s*\\bSec(?:tion)*)*\\.*", "Doctrine and Covenants"], ["dee and see", "Doctrine and Covenants"], ["moses", "Moses"], ["Abra*\\.*(?:ham)*", "Abraham"], ["Jos(?:eph)*\\.* Smith(?:[–—\\- ]+Matthew)", "Joseph Smith\u2014Matthew"], ["Jos(?:eph)*\\.* Smith(?:[–—\\- ]+History)", "Joseph Smith\u2014History"], ["JS[—\\-]*\\s*[H]", "Joseph Smith\u2014History"], ["JS[—\\-]*\\s*[M]", "Joseph Smith\u2014Matthew"], ["a(?:rticles)*[ _-]*o[ _-f]*f(?:aith)*", "Articles of Faith"], [",* *jst", "JST"], ["Jos(eph)*\\.* Smith('s)* Translation,*( of)*\\s*", "JST"], ["([^;-]*?)\\s*jst\\s*", "JST $1"], ["JST *,*[ —-]+", "JST "], ["JST Genesis 0", "Moses 1"], ["lect*(?:ures*)*(?: on faith)*\\.*", "Lectures on Faith"], ["l[ _-]*o*[ _-n]*f", "Lectures on Faith"], ["bo*c\\s*(\\d+)", "Book of Commandments $1"], ["(?:book of )*com(?:mandments)*", "Book of Commandments"], ["l *on* *f", "Lectures on Faith"], ["lec\\.*(?:tures*)(?: on faith)*", "Lectures on Faith"], ["(?:the )*(?:book of )*(?:the )*Law of the Lord", "Law"], ["Law", "The Law of the Lord"], ["tsp", "The Sealed Portion"], ["the sealed portion", "The Sealed Portion"], ["1\\s*(?:st)*\\s*v(?:ision)*", "First Vision"], ["W\\s*Moroni", "Words of Moroni"], ["Sealed Book of Moses", "The Sealed Book of Moses"], ["Acts of the Three Nephites", "The Acts of the Three Nephites"], ["qur['’ ]*(an)*", "Qur’an"], ["(?:al[ \\-––])*qur'*’*ani*c*(?:verses*)*", "Qur’an"], ["surah [a-z\\-–’']*(?: |:|–|\\-|v|vv|verses*)*", "Qur’an"], ["al[ \\-–][a-z\\-–’']+(?: |:|–|\\-|v|vv|verses*|ayab)*", "Qur’an"], ["kor(an)*", "Qur’an"], ["dh*p(ada)*", "Dhammapada"], ["d(ha|ah)mm*(apada)*", "Dhammapada"], ["b*h*(agavad)* *g(ita)*", "Bhagavad Gita"], ["tao( *te* *ching)*", "Tao Te Ching"], ["(Book of )+", "Book of "], ["( on Faith)+", " on Faith"], ["(Solomon's )+", "Solomon's "]],
  "pre_rules": [["[.]{2,}", ";"], ["(\\d+) (\\d+)", "$1.$2"], ["([0-9])[.]\\s*([0-9])", "$1:$2"], ["([a-z])[ .-]*0+", "$1"], ["^(\\d+)-", "$1"], [" ", " "], ["(first|1st|\\bi\\b)", "1"], ["(second|2nd|\\bii\\b)", "2"], ["(third|3rd|\\biii\\b)", "3"], ["(fourth|4th|\\biv\\b)", "4"], ["([0-9])th\\b", "$1"], ["([1-4])(st|nd|d|rd|th)\\b", "$1"], [",*\\s*\\b(?:ch\\b|chap(?:t*er)*s*)\\.*\\,*\\s*(\\d+)", "$1"], [",*\\s*\\b(?:sec\\b|section)\\.*\\s*(\\d+)", "$1"], ["([0-9]),*\\s*\\b(?:chapt*ers*|ch|chptrs*)\\.*,*\\s*([0-9])", "$1:$2"], ["([a-z]),*\\s*\\b(?:chapt*ers*|ch|chptrs*)\\s*([0-9])", "$1 $2"], ["[()]+", " "], ["[\\s.]*[–—−\\-]+[\\s.]*", "-"], ["&ndash;", "-"], ["([;,])\\s*and\\s*", "$1"], ["([0-9])[ .]*and[ .]*", "$1,"], ["(\\d)(\\.|: )(\\d)", "$1:$3"], ["\\s+(\\d+)[-–—](\\d+:\\d+)", " $1:1-$2"], ["(\\d)([A-Z])", "$1 $2"], ["(\\d) ([A-Z])$", "$1$2"], ["([0-9]),\\s*([1-4]*\\s*[a-z])", "$1; $2"], ["([a-z]), ([0-9])", "$1 $2"], ["\\.", " "], [" - ", " "], ["; ", ";"], [": ", ":"], ["(\\D)-(\\d)", "$1 $2"], ["([a-z]),", "$1"], ["jst(,| of )", "JST "], ["jst([a-z])", "JST $1"], [",\\s*((?:\\d+\\s)*[a-z])", "; $1"], ["\\bv*ve*r*s*e*s*\\s*([0-9])", ":$1"], ["(, *)*\\bverses*\\s*([0-9])", ":$1"], ["\\s*:", ":"], [";\\s*:", ":"], ["(\\d+) *to *(\\d+)", "$1-$2"], ["([—-])h", "\u2014H"], ["([—-])m", "\u2014M"], ["([A-za-z])(\\d)", "$1 $2"], ["([0-9]),\\s*([1-4]*\\s*[a-z])", "$1; $2"], ["o([nf])", "o$1"], ["([;,])", "$1 "], ["(the )*book of", ""], [",\\s*([0-9]+)\\s*:", "; $1:"], ["\\b\\s*cf[:.]*\\s*\\b", " "]],
  "post_rules": [["(Words of Mormon|Articles of Faith|4 Nephi|Jarom|Enos|Omni|Obadiah|2 John|3 John|Philemon|Jude|First Vision|Joseph Smith—.+)\\s+([2-9]|(\\d\\d+))", "$1 1:$2"], ["(^|;\\s*)(Nephi|cor|kings|chron|thes|pet|tim)", "$1 1 $2"], ["\\s+", " "], ["([a-z]\\s*\\d+)(-\\d+:\\d+)", "$1:1$2"], ["--", "\u2014"]]
};
var raw_lang = {
  ko: {
    spacing: ["", " "],
    books: {
      ...
      "스가랴": ["슥", "즈가리야"],
      "말라기": ["말", "말라기서"],
      "마태복음": ["마", "마태", "마태오 복음서", "마태오의 복음서"],
      "마가복음": ["막", "마가", "마르코 복음서"],
      "누가복음": ["눅", "[루누][가카]", "[루누][가카] *복음서*"],
      "요한복음": ["요", "요한", "요한 *복음서*"],
      "사도행전": ["사*도*행전*", "악"],
      "로마서": ["롬", "로마인들에게 보낸 편지"],
      "고린도전서": ["고전", "코린토1서"],
      "고린도후서": ["고후", "코린토2서"],
      "갈라디아서": ["갈"],
      "에베소서": ["엡", "에페소인들에게 보낸 편지"],
      "빌립보서": ["빌", "필리피서"],
      "골로새서": ["골", "콜로새서"],
      "데살로니가전서": ["살전", "테살로니카1서"],
      "데살로니가후서": ["살후", "테살로니카2서"],
      "디모데전서": ["딤전", "티모테오1서"],
      "디모데후서": ["딤후", "티모테오2서", "티모테후서"],
      "디도서": ["딛", "티토서"],
      "빌레몬서": ["몬", "필레몬서"],
      "히브리서": ["히"],
      "야고보서": ["약"],
      "베드로전서": ["베드로 전서", "벧전", "베드로1서"],
      "베드로후서": ["베드로 후서", "벧후", "베드로2서"],
      "요한일서": ["요1", "요(일|1)", "(일|1)요"],
      "요한이서": ["요2", "요(이|2)", "(이|2)요"],
      "요한삼서": ["요3", "요(삼|3)", "(삼|3)요"],
      "유다서": ["유다*", "유다의 편지"],
      "요한 계시록": ["계시*록*", "요한 *[묵계]시록"],
      "니파이전서": ["니전"],
      "니파이후서": ["니후"],
      "야곱서": ["야곱"],
      "이노스서": ["이노", "이노스서"],
      ...
      "모세서": ["모세"],
      "아브라함서": ["아브", "아브라함"],
      "조셉 스미스—마태복음": ["조마", "조셉 스미스—마태"],
      "조셉 스미스—역사": ["조역", "조셉 스미스—역사"],
      "신앙개조": ["신개"]
    },
    pre_rules: [
    //handle 1장 2절-3절
    //turn 30 장 10 절 into 30장 10절
    ["부터", "-"], ["(\\d+)\\s*장\\s*(\\d+)(?:~|-)(\\d+)\\s*절*", "$1:$2-$3"], ["(비교|또는*|그리고|과|와|및)", ";"],
    //handle 1장 2절
    ["(\\d+)\\s*장\\s*(\\d+)\\s*절*", "$1:$2"], ["~", "-"], ["(\\d+)\\s*장", "$1"], ["(\\d+)\\s*절", "$1"], ["([\\u3131-\\uD79D]) *(\\d+)", "$1 $2"], ["제 (\\d)", "제$1"], ["조셉 스미스[—-]", "조셉 스미스—"], [", *([^0-9])", ";  $1"]],
    post_rules: [["([\\u3131-\\uD79D]) *([0-9]+)", "$1 $2장 "], ["([0-9]+):([0-9]+)-([0-9]+)", "$1장 $2~$3절"], ["[–-]+", "~"], ["\\s*:\\s*([0-9~]+)", ":$1절"], ["([0-9]+):([0-9]+)", "$1장$2"], ["장:([0-9]+)", "장 $1"], [";", "; "], ["\\s+", " "], ["제\\s*([3-4])장\\s*니파이", "제$1니파이"], ["([0-9]+)장\\s*([0-9]+)", "$1장 $2"]],
    matchRules: {
      book: "(제[0-9]+)*",
  ...
  de: {
    books: {
      "Genesis": ["gen", "1\\.* *(buch )*mose"],
      "Exodus": ["ex", "2\\.* *(buch )*mose"],
      "Leviticus": ["lev", "3\\.* *(buch )*mose"],
      "Numbers": ["num", "4\\.* *(buch )*mose"],
      "Deuteronomy": ["dtn", "5\\.* *(buch )*mose"],
      "Josua": ["jos"],
      "Richter": ["ri"],
      "Rut": ["rut"],
      "1 Samuel": ["1 sam"],
      ...
      "Mose": ["mose"],
      "Abraham": ["abr"],
      "Joseph Smith—Matthäus": ["jsmt"],
      "Joseph Smith—Lebensgeschichte": ["jslg"],
      "Glaubensartikel": ["ga"]
    }
  },
  swe: {
    books: {
      ...
      "Filipperbrevet": ["fil"],
      "Kolosserbrevet": ["kol"],
      "1 Tessalonikerbrevet": ["1 tess"],
      "2 Tessalonikerbrevet": ["2 tess"],
      ...
      "Ether": ["eth"],
      "Moroni": ["moro"],
      "Läran och förbunden": ["l&f"],
      "Mose": ["mose"],
      "Abraham": ["abr"],
      "Joseph Smith – Matteus": ["js-m"],
      "Joseph Smith – Historien": ["js-h"],
      "Trosartiklarna": ["ta"]
    }
  },
  ru: {
    books: {
      ...
      "3я Царств": ["3[яек]* Цар"],
      "4-я Царств": ["4 Цар"],
      "1я Паралипоменон": ["1[яек]* Пар"],
      "2я Паралипоменон": ["2[яек-]* Пар"],
      "Ездра": ["Езд"],
      "Неемия": ["Неем"],
      "Есфирь": ["Есф"],
      "Иов": ["Иов"],
      ...
      "Деяния": ["Деян"],
      "К Римлянам": ["Рим"],
      "1е к Коринфянам": ["1[яек]* Кор"],
      "2е к Коринфянам": ["2[яек]* Кор"],
      "К Галатам": ["Гал"],
      "К Ефесянам": ["Еф"],
      "К Филиппийцам": ["Флп"],
      "К Колоссянам": ["Кол"],
      "1е к Фессалоникийцам": ["1[яек]* Фес"],
      "2е к Фессалоникийцам": ["2[яек]* Фес"],
      "1е к Тимофею": ["1[яек]* Тим"],
      "2е к Тимофею": ["2[яек]* Тим"],
      "К Титу": ["Тит"],
      "К Филимону": ["Флм"],
      "К Евреям": ["Евр"],
      "Иакова": ["Иакова"],
      ...
      "Ефер": ["Ефер"],
      "Мороний": ["Морон"],
      "Учение и Заветы": ["У и З"],
      "Моисей": ["Моис"],
      "Авраам": ["Авр"],
      "Джозеф Смит – от Матфея": ["ДжС–Мф"],
      "Джозеф Смит – История": ["ДжС–Ист"],
      "Символы веры": ["С В"]
    },
    pre_rules: [["([1-3])[ –-]*([яек])", "$1$2"], ["p", "р"]],
    post_rules: [["([1-3])-*([ея])", "$1-$2"]]
  },
  vn: {
    pre_rules: [
    //replace dashes in book names with spaces
    ["-([^0-9 ])", " $1"], [", *([^0-9])", ";  $1"], ["(hoặc|và|so với)", "; "], [";\\s*Giao", "và Giao"]],
    books: {
      "Sáng Thế": ["STK[yý]", "Sáng Thế Ký", "S[áa]ng *Th[ếe] *(K[yý])*"],
      "Xuất Ê Díp Tô": ["X[ÊE]DT(K[ýy])*", "X[úu]at *Ê *D[íi]p *T[ôo] *(K[yý])*", "Xu[ấa]t h[àa]nh *(k[yý])*"],
      "Lê Vi": ["L[êe] *Vi *(K[yý])*", "LV(K[ýy])*"],
      "Dân Số": ["DS(K[yý])*", "D[âa]n *S[ốo] *(K[yý])*"],
      "Phục Truyền Luật Lệ": ["PTLL(K[yý])*", "Ph[úu]c *Truy[ềe]n *Lu[ậa]t *L[ệe] *(K[yý])*"],
      "Giô Suê": ["Gi[ôo] *Su[êe]"],
      "Các Quan Xét": ["C[áa]c *Quan *X[ée]t", "QX[ée]t"],
      "Ru Tơ": ["Ru *T[ơo]"],
      "1 Sa Mu Ên": ["1 *Sa *Mu *Ên", "1 *SM[EÊ]n"],
      "2 Sa Mu Ên": ["2 *Sa *Mu *Ên", "2 *SM[EÊ]n"],
      "1 Các Vua": ["1 *C[áa]c *Vua", "1 *Vua"],
      "2 Các Vua": ["2 *C[áa]c *Vua", "2 *Vua"],
      "1 Sử Ký": ["1 *S[ửu] *K[yý]"],
      "2 Sử Ký": ["2 *S[ửu] *K[yý]"],
      "E Xơ Ra": ["E *X[ơo] *Ra"],
      "Nê Hê Mi": ["N[êe] *H[êe] *Mi"],
      "Ê Xơ Tê": ["Ê *X[ơo] *T[êe]"],
      "Gióp": ["Gi[óo]p"],
      "Thi Thiên": ["Th*i* *Thi[êe]n"],
      "Châm Ngôn": ["Ch[âa]m *Ng[ôo]n", "CNg[ôo]n"],
      "Truyền Đạo": ["T[DĐ][aạ]o", "Truy[ềe]n *[ĐD]a[ọo]"],
      "Nhã Ca": ["Nh[ãa] *Ca"],
      "Ê Sai": ["[ÊE] *Sai"],
      "Giê Rê Mi": ["GRMi", "Gi[êe] *R[êe] *Mi"],
      "Ca Thương": ["CTh[uư][oơ]ng", "Ca *Th[ưu]ng"],
      "Ê Xê Chi Ên": ["[EÊ]XC[EÊ]n", "Ê *X[êe] *Chi *[ÊE]n"],
      "Đa Ni Ên": ["[DĐ]N[EÊ]n", "[ĐD]a *Ni *[ÊE]n"],
      "Ô Sê": ["[ÔO] *S[êe]"],
      "Giô Ên": ["Gi[ôo] *[ÊE]n"],
      "A Mốt": ["A *M[ốo]t"],
      "Áp Đia": ["[ÁA]p *Đia"],
      ...
      "Mi Chê": ["Mi *Ch[êe]"],
      "Na Hum": ["Na *Hum"],
      "Ha Ba Cúc": ["HBCuc", "Ha *Ba *C[úu]c"],
      "Sô Phô Ni": ["S[ôo]* *Ph*[ôo]* *Ni"],
      "A Ghê": ["A *Gh[êe]"],
      "Xa Cha Ri": ["Xa* *Ch*a* *Ri"],
      "Ma La Chi": ["Ma* *La* *Chi"],
      "Ma Thi Ơ": ["Ma *Thi *[ƠO]", "MT[OƠ]"],
      "Mác": ["M[áa]c"],
      "Lu Ca": ["Lu *Ca"],
      "Giăng": ["Gio*[ăa]ng*"],
      "Công Vụ Các Sứ Đồ": ["C[ôo]ng *Vụ *C[áa]c *Sứ *Đ[ồo]", "CVCS[ĐD]"],
      "Rô Ma": ["R[ôo] *Ma"],
      "1 Cô Rinh Tô": ["1 *C[ôo]* *Ri*n*h* *T[ôo]"],
      "2 Cô Rinh Tô": ["2 *C[ôo]* *Ri*n*h* *T[ôo]"],
      "Ga La Ti": ["Ga *La *Ti"],
      "Ê Phê Sô": ["[ÊE] *Ph[êe] *S[ôo]", "[ÊE]PS[ÔO]"],
      "Phi Líp": ["Phi *L[íi]p"],
      "Cô Lô Se": ["C[ôo] *L[ôo] *Se", "CL[ÔO]*Se"],
      "1 Tê Sa Lô Ni Ca": ["1 *Tê *Sa *L[ôo] *Ni *Ca", "1 *TSLN[ÔO]Ca", "1 TSLNCa"],
      "2 Tê Sa Lô Ni Ca": ["2 TSLNCa", "2 *Tê *Sa *L[ôo] *Ni *Ca", "2 *TSLN[ÔO]Ca"],
      "1 Ti Mô Thê": ["1 *Ti *Mô *Th[êe]", "1 *TMTh[ÊE]"],
      "2 Ti Mô Thê": ["2 *Ti *Mô *Th[êe]", "2 *TMTh[ÊE]"],
      "Tít": ["T[íi]t"],
      "Phi Lê Môn": ["Phi *L[êe] *Môn", "PL[ÊE]M[ÔO]n", "PLM[oô]n"],
      "Hê Bơ Rơ": ["H[êe] *Bơ *Rơ", "HBR[ƠO]"],
      "Gia Cơ": ["GLTi", "Gia *C[ơo]"],
      "1 Phi E Rơ": ["1 *Phi *E *R[ơo]", "1 *PER[ƠO]"],
      "2 Phi E Rơ": ["2 *Phi *E *R[ơo]", "2 *PER[ƠO]"],
      "1 Giăng": ["1 *Gio*[ăa]ng*"],
      "2 Giăng": ["2 *Gio*[ăa]ng*"],
      "3 Giăng": ["3 *Gio*[ăa]ng*"],
      "Giu Đe": ["Giu *[ĐD]e"],
      "Khải Huyền": ["Kh[ảa]i *Huy[ềe]n", "KHuy[ềe]n"],
      "1 Nê Phi": ["1 *N[êe] *Phi"],
      "2 Nê Phi": ["2 *N[êe] *Phi"],
      "Gia Cốp": ["Gi*a* *C[ốo]p"],
      "Ê Nót": ["[ÊE] *N[óo]t"],
      "Gia Rôm": ["Gi*a* *R[ôo]m"],
      "Ôm Ni": ["[ÔO]m *Ni"],
      "Lời Mặc Môn": ["L[ờo]i *M[ặa]c *M[ôo]n", "LMM[ÔO]n"],
      "Mô Si A": ["M[ôo] *Si *A"],
      "An Ma": ["An *Ma"],
      "Hê La Man": ["H[êe]* *La* *Man"],
      "3 Nê Phi": ["3 *N[êe] *Phi"],
      "4 Nê Phi": ["4 *N[êe] *Phi"],
      "Mặc Môn": ["M[ậa]c *M[ôo]n", "MM[ÔO]n"],
      "Ê The": ["[ÊE] *The"],
      "Mô Rô Ni": ["M[ôo] *R[ôo] *Ni", "MRN[ÎI]"],
      "Giáo Lý và Giao Ước": ["Gi[áa]o *L[ýi] *v[àa] *Giao *[ƯU][ớo]c", "GLG[ƯU]"],
      "Môi Se": ["M[ôo]i *Se"],
      "Áp Ra Ham": ["[ÁA]p *Ra *Ham", "ARH[ÂA]m"],
      "Joseph Smith—Ma Thi Ơ": ["Joseph *Smith—Ma *Thi *[ƠO]", "JS—MT[ƠO]"],
      "Joseph Smith—Lịch Sử": ["Joseph *Smith—L[ịi]ch *S[ửu]", "JS—LS"],
      "Những Tín Điều": ["Nh[ữu]ng *T[íi]n *[ĐD]i[ềe]u", "NT[ĐD]"]
    },
    matchRules: {
      book: "(Th\u1EE9 nh\u1EA5t|I|1|Th\u1EE9 hai|II|2|Th\u1EE9 ba|III|3|Th\u1EE9 t\u01B0|IV|4)*\\s*(S\xE1ch* c\u1EE7a)*\\s*",
  ...
  fr: {
    ...
    pre_rules: [["Smith[,—–-]+", "Smith"], ["JS[,—–-]+ *", "JS"], ["le (.*) livre de", "$1"], ["(premier|première|1er|1ère)", "1"], ["(deuxième|2ème|II)", "2"], ["(troisième|3ème|III)", "3"], ["(quatrième|4ème|IV)", "4"], [",*\\s*(chapitre|ch[.]|section)*\\s*([0-9]+)", "$2"]
    //["\\s*(:|,|\\.)\\s*(v+[.]*|verset|versets)*\\s*([0-9]*)", "$3"],
    ],
    post_rules: [["Smith (H|M)", "Smith, $1"]],
    matchRules: {
      jst: "JSH",
      book: "(Premier|Premi\xE8re|I|1|1er|1\xE8re|Deuxi\xE8me|II|2|2\xE8me|Troisi\xE8me|III|3|3\xE8me|Quatri\xE8me|IV|4|4\xE8me)*\\s*(livres* de)*\\s*",
      verse: "\\s*(:|,|\\.)\\s*(v+[.]*|verset|versets)*\\s*[0-9]*",
      joiners: ["^[ ,;]*(et|aussi|voir|voir aussi|v\\. *a\\.)*\\s*:*$"]
    }
  },
  tgl: {
    books: {
      ...
      "Mga Taga-Efeso": ["Ef."],
      "Mga Taga-Filipos": ["Fil."],
      "Mga Taga-Colosas": ["Col."],
      "1 Mga Taga-Tesalonica": ["1 Tes."],
      "2 Mga Taga-Tesalonica": ["2 Tes."],
      "1 Kay Timoteo": ["1 Tim."],
      "2 Kay Timoteo": ["2 Tim."],
      "Kay Tito": ["Tit."],
      "Kay Filemon": ["Flm."],
      ...
      "Eter": ["Eter"],
      "Moroni": ["Moro."],
      "Doktrina at mga Tipan": ["D at T"],
      "Moises": ["Moi."],
      "Abraham": ["Abr."],
      "Joseph Smith—Mateo": ["JS—M"],
      "Joseph Smith—Kasaysayan": ["JS—K"],
      "Ang mga Saligan ng Pananampalataya": ["S ng P"]
    }
  },
  jp: {
    books: {
      ...
      "ゼカリヤ書": ["ゼカ", "ゼカリヤ書"],
      "マラキ書": ["マラ", "マラキ書"],
      "マタイによる福音書": ["マタ", "マタイによる福音書"],
      "マルコによる福音書": ["マコ", "マルコによる福音書"],
      "ルカによる福音書": ["ルカ", "ルカによる福音書"],
      "ヨハネによる福音書": ["ヨハ", "ヨハネによる福音書"],
      "使徒行伝": ["使徒", "使徒行伝"],
      "ローマ人への手紙": ["ロマ", "ローマ人への手紙"],
      "コリント人への第一の手紙": ["1コリ", "コリント人への第一の手紙"],
      "コリント人への第二の手紙": ["2コリ", "コリント人への第二の手紙"],
      "ガラテヤ人への手紙": ["ガラ", "ガラテヤ人への手紙"],
      "エペソ人への手紙": ["エペ", "エペソ人への手紙"],
      "ピリピ人への手紙": ["ピリ", "ピリピ人への手紙"],
      "コロサイ人への手紙": ["コロ", "コロサイ人への手紙"],
      "テサロニケ人への第一の手紙": ["1テサ", "テサロニケ人への第一の手紙"],
      "テサロニケ人への第二の手紙": ["2テサ", "テサロニケ人への第二の手紙"],
      "テモテへの第一の手紙": ["1テモ", "テモテへの第一の手紙"],
      "テモテへの第二の手紙": ["2テモ", "テモテへの第二の手紙"],
      "テトスへの手紙": ["テト", "テトスへの手紙"],
      "ピレモンへの手紙": ["ピレ", "ピレモンへの手紙"],
      "ヘブル人への手紙": ["ヘブ", "ヘブル人への手紙"],
      "ヤコブの手紙": ["新ヤコ", "ヤコブの手紙"],
      "ペテロの第一の手紙": ["1ペテ", "ペテロの第一の手紙"],
      "ペテロの第二の手紙": ["2ペテ", "ペテロの第二の手紙"],
      "ヨハネの第一の手紙": ["1ヨハ", "ヨハネの第一の手紙"],
      "ヨハネの第二の手紙": ["2ヨハ", "ヨハネの第二の手紙"],
      "ヨハネの第三の手紙": ["3ヨハ", "ヨハネの第三の手紙"],
      "ユダの手紙": ["ユダ", "ユダの手紙"],
      "ヨハネの黙示録": ["黙示", "ヨハネの黙示録"],
      "ニーファイ第一書": ["1ニフ", "ニーファイ第一書"],
      "ニーファイ第二書": ["2ニフ", "ニーファイ第二書"],
      "ヤコブ書": ["ヤコ", "ヤコブ書"],
      "エノス書": ["エノ", "エノス書"],
      "ジェロム書": ["ジェロ", "ジェロム書"],
      "オムナイ書": ["オム", "オムナイ書"],
      ...
      "モーセ書": ["モセ", "モーセ書"],
      "アブラハム書": ["アブ", "アブラハム書"],
      "ジョセフ・スミス—マタイ": ["ジ—マタ", "ジョセフ・スミス—マタイ"],
      "ジョセフ・スミス—歴史": ["ジ—歴史", "ジョセフ・スミス—歴史"],
      "信仰箇条": ["箇条", "信仰箇条"]
    }
  },
  tr: {
    books: (_books = {
      ...
      "1 Nefi": ["1 Nef"],
      "2 Nefi": ["2 Nef"]
    }, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_books, "Yakup", ["Yakup"]), "Enos", ["Enos"]), "Yarom", ["Yarom"]), "Omni", ["Omni"]), "Mormon'un Sözleri", ["Mor Söz"]), "Mozya", ["Moz"]), "Alma", ["Alma"]), "Helaman", ["Hel"]), "3 Nefi", ["3 Nef"]), "4 Nefi", ["4 Nef"]), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_books, "Mormon", ["Mormon"]), "Ether", ["Eter"]), "Moroni", ["Moroni"]), "Öğreti ve Antlaşmalar", ["Ö&A"]), "Musa", ["Mus"]), "İbrahim", ["İbra"]), "Joseph Smith—Matta", ["JS—Mat"]), "Joseph Smith—Tarih", ["JS—Tarih"]), "İnanç Makaleleri", ["İM"]))
  },
  slv: {
    books: {
      // Old Testament
  ...
  eo: {
    books: (_books2 = {
      ...
      "Filipianoj": ["Fil"],
      "Koloseanoj": ["Kol"],
      "1 Tesalonikanoj": ["1 Tes"],
      "2 Tesalonikanoj": ["2 Tes"],
      "1 Timoteo": ["1 Tim"],
      "2 Timoteo": ["2 Tim"],
      "Tito": ["Tit"],
      "Filemon": ["Fil"],
      ...
      "1 Nefi": ["1 Nef"],
      "2 Nefi": ["2 Nef"]
    }, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_books2, "Jakobo", ["JakK"]), "Enos", ["Eno"]), "Jerom", ["Jerom"]), "Omni", ["Omni"]), "La Vortoj de Mormon", ["Vortoj Morm"]), "Mosiah", ["Mos"]), "Alma", ["Alma"]), "Helaman", ["Hel"]), "3 Nefi", ["3 Nef"]), "4 Nefi", ["4 Nef"]), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_books2, "Mormon", ["Morm"]), "Eter", ["Eter"]), "Moroni", ["Moroni"]), "Doktrino kaj Interligoj", ["D&I"]), "Moseo", ["Mos"]), "Abraham", ["Abr"]), "Joseph Smith—Mateo", ["JS-Mat"]), "Joseph Smith—Historio", ["JS-Historio"]), "Kredo Artikoloj", ["KA"]))
  }
};
var findMatchingBooks = function findMatchingBooks(content, books) {
  var matchingBooks = books.filter(function (i) {
    return new RegExp(i, "ig").test(content);
  });
  return matchingBooks;
};
var findMatches = function findMatches(content, books, lang_extra) {
  var tail = lang_extra.tail ? new RegExp(lang_extra.tail, "ig") : /[^0-9]+$/;
  var preBookMatch = lang_extra.book || "(First|I|1|1st|Second|II|2|2nd|Third|III|3|3rd|Fourth|IV|4|4th)*\\s*(books* of)*\\s*";
  var matchingBooks = findMatchingBooks(content, books);
  var postBookMatch = lang_extra.chapter || "([0-9:.;,~ —–-]|cf|(?:&ndash;))*[0-9]+";
  var fullBookMatches = matchingBooks.map(function (bookMatch) {
    var patternString = preBookMatch + bookMatch;
    var pattern = new RegExp(patternString, "ig");
    var stringMatch = pattern.test(content) ? patternString : null;
    //console.log({pattern,content,stringMatch});
    return stringMatch;
  }).filter(function (x) {
    return !!x;
  });
  var bookSubStrings = fullBookMatches.map(function (bookMatch) {
    var substrings = content.match(new RegExp(bookMatch, "ig")).flat();
    return substrings;
  }).flat().reduce(function (prev, current) {
    ...
    var positions = [];
    var index = content.indexOf(substring);
    while (index != -1) {
    ...
    var _ref2 = _slicedToArray(_ref, 2),
      substring = _ref2[0],
      positions = _ref2[1];
    var preChars = positions.map(function (i) {
      return content.substring(i - 1, i);
    });
    positions = positions.filter(function (i, index) {
      var charRightBeforeMatch = preChars[index];
      var leadingCharIsInvalid = !/^(\s|\W|)$/.test(charRightBeforeMatch);
  ...
  var possiblyOverlappingMatches = bookSubStrings.map(function (_ref3) {
    var _ref4 = _slicedToArray(_ref3, 2),
      substring = _ref4[0],
      positions = _ref4[1];
    return positions.map(function (i) {
      var _content$slice$match;
      var pattern = null;
      try {
      ...
      var match = (_content$slice$match = content.slice(i).match(pattern)) === null || _content$slice$match === void 0 || (_content$slice$match = _content$slice$match[0]) === null || _content$slice$match === void 0 ? void 0 : _content$slice$match.replace(tail, "").trim();
  ...
  var matchesWithReferences = possiblyOverlappingMatches.map(function (_ref5) {
    var _ref6 = _slicedToArray(_ref5, 3),
      string = _ref6[0],
      start = _ref6[1],
      end = _ref6[2];
    var overLappingItems = possiblyOverlappingMatches.filter(function (_ref7) {
      var _ref8 = _slicedToArray(_ref7, 3),
        s = _ref8[0],
        s1 = _ref8[1],
        e1 = _ref8[2];
      return s !== string && s1 < end && e1 > end;
    });
    var hasOverlap = overLappingItems.length > 0;
    var newEnd = hasOverlap ? Math.min.apply(Math, _toConsumableArray(overLappingItems.map(function (_ref9) {
    ...
    var newString = content.slice(start, newEnd);
    return newString.replace(tail, "").trim();
  }).filter(function (i) {
    return !!i;
  });
  var matches = matchesWithReferences.map(function (string) {
    var _content$match;
    var pattern = new RegExp(string, "ig");
    var matches = (_content$match = content.match(pattern)) === null || _content$match === void 0 ? void 0 : _content$match.map(function (i) {
      return i.trim().replace(tail, "");
    });
...
function findMatchIndexes(content, matches, lookupReference, lang_extra) {
  var tail = lang_extra.tail ? new RegExp(lang_extra.tail, "ig") : /[^0-9]+$/;
  var indexes = matches.sort(function (b, a) {
    return b.length - a.length;
  }).map(function (i) {
    var length = i.length;
    var positions = [];
    var strPos = content.indexOf(i);
    while (strPos != -1) {
    ...
    var substring = content.substring(a[0], a[1]).trim().replace(tail, "").trim();
    if (!substring) return false;
    var verse_ids = lookupReference(substring).verse_ids;
    ...
    return a[0] - b[0];
  }).map(function (_ref1, index, array) {
    var _array;
    var _ref10 = _slicedToArray(_ref1, 2),
      start = _ref10[0],
      end = _ref10[1];
    var nextStart = ((_array = array[index + 1]) === null || _array === void 0 ? void 0 : _array[0]) || null;
    end = nextStart ? Math.min(end, nextStart) : end;
    return [start, end];
  });
  if (!indexes.length) return false;
  var tieBreaker = function tieBreaker(pair1, pair2) {
    var string1 = content.substring(pair1[0], pair1[1]);
    var string2 = content.substring(pair2[0], pair2[1]);
  ...
  var nonOverlappingIndeces = indexes.reduce(function (prev, current) {
    if (prev.length === 0) {
      return [current];
    }
    var lastPair = prev[prev.length - 1];
    if (current[0] < lastPair[1]) {
      // They overlap
      var chosenPair = tieBreaker(lastPair, current);
...
var processReferenceDetection = function processReferenceDetection(content, books, lang_extra, lookupReference, callback) {
  try {
    lang_extra = lang_extra || {};
    var matches = findMatches(content, books, lang_extra);
    var matchIndeces = findMatchIndexes(content, matches, lookupReference, lang_extra);
    if (!matchIndeces) return content;
    var gapsBetweenIndeces = matchIndeces.reduce(function (prev, current, index) {
      if (index === 0) return prev;
      var lastPair = matchIndeces[index - 1];
      var gap = [lastPair[1], current[0]];
      return [].concat(_toConsumableArray(prev), [gap]);
    }, []);
    var gapStrings = gapsBetweenIndeces.map(function (_ref13) {
    ...
    var gapThatMayBeMerged = gapsBetweenIndeces.map(function (_ref15, i) {
      ...
      var gapString = gapStrings[i];
      var canBeMerged = joiners.some(function (joiner) {
        return new RegExp(joiner, "ig").test(gapString);
      });
      var matchingJoiner = joiners.find(function (joiner) {
        return new RegExp(joiner, "ig").test(gapString);
      });
    ...
    // new incexes
    var mergedIndeces = matchIndeces.reduce(function (prev, current, index) {
      if (index === 0) {
        return [current];
      } else {
        var prevIndex = prev[prev.length - 1];
        if (gapThatMayBeMerged[index - 1]) {
          var _merged = [prevIndex[0], current[1]];
          prev[prev.length - 1] = _merged;
        } else {
          prev.push(current);
        }
        return prev;
    ...
    var negativeSpace = mergedIndeces.reduce(function (prev, current, index, array) {
      if (index !== 0) {
        var prevIndex = array[index - 1];
        var gap = [prevIndex[1], current[0]];
        prev.push(gap);
      }
      return prev;
    }, []);
    ...
    var cutItems = mergedIndeces.map(function (_ref17) {
      var _ref18 = _slicedToArray(_ref17, 2),
        start = _ref18[0],
        end = _ref18[1];
      var string = content.substring(start, end);
      return lookupReference(string).query;
    }).map(callback);
    var negativeItems = negativeSpace.map(function (_ref19) {
      var _ref20 = _slicedToArray(_ref19, 2),
        start = _ref20[0],
        end = _ref20[1];
      return content.substring(start, end);
    });
    var firstReferenceIsAtStart = mergedIndeces[0][0] === 0;
...
var _lookupReference = exports.ref2VerseId = exports.read = exports.parse = exports.lookup = exports.lookupReference = function lookupReference(query) {
  var _verse_ids;
  ...
  if (!((_verse_ids = verse_ids) !== null && _verse_ids !== void 0 && _verse_ids.length) && effectiveLanguage && effectiveLanguage !== 'en') {
    var results = _lookupReference(query, 'en');
    return results;
  }
  return {
    "query": query,
...
var cleanReference = function cleanReference(messyReference, config) {
  ...
  var _ref21 = config.raw_regex.spacing || ["\\b", ""],
...
var detectReferences = exports.linkRefs = exports.detectScriptures = exports.detectRefs = exports.detectScriptureReferences = exports.detect = exports.detectReferences = function detectReferences(content, callBack) {
  ...
  return processReferenceDetection(content, books, config.lang_extra, function (query) {
    return _lookupReference(query, effectiveLanguage);
  }, callBack);
};
var getLanguageConfig = function getLanguageConfig(language) {
  // Default to English if no language specified or not found
  var effectiveLanguage = language && raw_lang[language] ? language : 'en';
  var config = {
    language: effectiveLanguage,
    raw_index: raw_index_orig,
    raw_regex: _objectSpread({}, raw_regex_orig),
    lang_extra: {},
    wordBreak: "\\b"
  };
  ...
  var langData = raw_lang[effectiveLanguage];
  if (langData.books) {
