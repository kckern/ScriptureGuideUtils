export default {
    ko:{
        ...
        matchRules:{
            book: "(제[0-9]+)*",
            chapter:"([장절편과와및0-9:;,~\\s—–-]|부터|그리고|또는*)*[0-9장절편]+",
            verse:"절",
